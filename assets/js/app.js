        ...
        fetchData(url.forecast(lat, lon), function (forecast) {
            ...
            for (const [index, data] of forecastList.entries()) {
                ...
                hourlySection
                    ...
                    .appendChild(tempList);

                const windList = document.createElement("li");
                windList.classList.add("slider-item", "slide");
                windList.innerHTML = `
                    <div class="card card-sm slider-card">
                        <p class="body-3">${module.getHours(
                            dateTimeUnix,
                ...
                hourlySection
                    ...
                    .appendChild(windList);
            }

            /**
             * 5 Day Forecast Sectioni
             */
            forecastSection.innerHTML = `
            ...
            for (let i = 7; i < forecastList.length; i += 8) {
                ...
                const fiveDayForecastList = document.createElement("li");
                fiveDayForecastList.classList.add("card-item");
                ...
                forecastSection
                    ...
                    .appendChild(fiveDayForecastList);
            }
